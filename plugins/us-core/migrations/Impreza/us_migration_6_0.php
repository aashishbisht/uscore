...
class us_migration_6_0 extends US_Migration_Translator {
	...
	private function create_shop_template( $is_shop = FALSE ) {
		...
		if ( $is_shop ) {
			...
			$content_template .= '[us_product_field type="featured_badge" font_size="13px" font_weight="700" text_transform="uppercase" css=".vc_custom_1204201900002{margin-bottom: 1rem !important;padding-right: 0.8rem !important;padding-left: 0.8rem !important;border-radius: 35px !important;}"]';			
			// Breadcrumbs
